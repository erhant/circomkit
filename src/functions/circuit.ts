 ...
 * @param usesCustomTemplates include the pragma custom_templates
 */
export function instantiateCircuit(config: Required<CircuitConfig>, targetDir: string, targetPath: string, usesCustomTemplates: boolean) {
...
export function makeCircuit(config: Required<CircuitConfig>, usesCustomTemplates: boolean) {
